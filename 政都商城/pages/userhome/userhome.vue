	...
	<view >
		<view class="top-bar">
			<view class="top-bar-left" @tap="backOne">
				<image src="/static/static_public_img/back.png" class="back-img"></image>
			</view>
			<view class="top-bar-center"></view>
			<view class="top-bar-right">
				<view class="more-img" >
					<image src="/static/static_public_img/more.png"></image>
				</view>
			</view>
		</view>
		<view class="bg">
			<view class="bg-bai" :animation="animationData4"></view>
			<image src="/static/static_public_img/three.png" class="bg-img" mode="aspectFill"></image>
		</view>
		<view class="main">
			<view class="user-header">
				<view class="sex" :style="{background:sexBg}" :animation="animationData3">
					<image src="/static/static_public_img/female.png"></image>
				</view>
				<image src="/static/static_public_img/three.png" mode="aspectFill" class="user-img" :animation="animationData2"></image>
			</view>
			<view class="user-imf">
